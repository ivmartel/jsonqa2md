 ...
 * @param {string} type The numbered type.
 * @returns A string as '%number% %type%[s]'.
 */
...
/**
 * Check if an input json is from a Karma test.
 *
 * @param {object} testJSON The json to check.
 * @returns {boolean} True if from Karma.
 */
...
/**
 * Parse an input json generated by Karma to get the test context.
 *
 * @param {object} testJSON The json to parse.
...
/**
 * Parse an input json generated by Karma to get the test suites.
 *
 * @param {object} testJSON The json to parse.
...
/**
 * Check if an input json is from a Vitest test.
 *
 * @param {object} testJSON The json to check.
 * @returns {boolean} True if from Vitest.
 */
...
/**
 * Parse an input json generated by Vitest to get the test context.
 *
 * @param {object} testJSON The json to parse.
 * @returns {object} A context object.
 */
...
/**
 * Parse an input json generated by Vitest to get the test suites.
 *
 * @param {object} testJSON The json to parse.
 * @returns {object} A test suite object with all the test results.
 */
...
/**
 * Add requirement context to test results.
 *
 * @param {object} testSuites The test suites.
 * @param {object} requirements The requirements.
 * @param {string} testDescPattern The pattern of the test decription.
 * @returns {number, number} Number of tests with no requirement or
 *   bad requirement.
 */
...
/**
 * Get the requirement groups from the requirements.
 *
 * @param {object} requirements The requirements.
 * @returns {object, number} The requirements groups and
 * the number of requirements with no test.
 */
